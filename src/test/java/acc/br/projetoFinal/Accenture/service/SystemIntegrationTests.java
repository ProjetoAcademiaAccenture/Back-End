...
class SystemIntegrationTests {
    ...
    void deveDepositarNaContaDoCliente() {
        var contaAtualizada =
                contaRepository.findById(contaCliente.getId()).orElseThrow();
    ...
    void deveBuscarClientePorCPF() {
        ...
        ClienteResponseDTO encontrado =
                clienteService.buscarPorCpf("10123456789");
    ...
    void deveCriarMultiplosCLientes() {
        ...
        clienteRequest2.setEndereco(
                criarEnderecoPadrao("01310100", "50"));

        ClienteResponseDTO cliente2 =
                clienteService.criar(clienteRequest2);
    ...
    void deveValidarCPFDuplicado() {
        ...
        duplicado.setEndereco(
                criarEnderecoPadrao("01310100", "50"));

        assertThrows(
                Exception.class,
                () -> clienteService.criar(duplicado));
    }
