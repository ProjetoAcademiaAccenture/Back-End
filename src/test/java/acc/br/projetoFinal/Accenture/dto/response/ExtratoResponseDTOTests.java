...
class ExtratoResponseDTOTests {
    ...
    // Cobre o branch de cada enum em extrato.getTipo().name()
    // =========================================================

    @Test
    @DisplayName("fromEntity: deve mapear tipo CREDITO")
    void fromEntity_TipoCredito_DeveMappearStatus() {
    ...
    void fromEntity_TipoDebito_DeveMappearStatus() {
    ...
    void fromEntity_TipoEstorno_DeveMappearStatus() {
        extrato.setTipo(TipoExtrato.ESTORNO);
        assertEquals("ESTORNO", ExtratoResponseDTO.fromEntity(extrato).getTipo());
    }

    @Test
    @DisplayName("fromEntity: deve mapear tipo MULTA")
    void fromEntity_TipoMulta_DeveMappearStatus() {
        extrato.setTipo(TipoExtrato.MULTA);
        assertEquals("MULTA", ExtratoResponseDTO.fromEntity(extrato).getTipo());
    }

    // =========================================================
    // TESTES: fromEntity() — branch do operador ternário
    ...
    void fromEntity_ValorMaximo_DeveMappearCorretamente() {
        ...
        ExtratoResponseDTO dto = ExtratoResponseDTO.fromEntity(extrato);
        assertEquals(new BigDecimal("99999999.99"), dto.getValor());
    }
    ...
    void noArgsConstructor_DeveCriarInstanciaVazia() {
        assertNotNull(new ExtratoResponseDTO());
    }
    ...
    void settersGetters_DeveAtribuirERetornarCampos() {
        ...
        dto.setDescricao("Multa de cancelamento");
        dto.setPedidoId(5L);
        dto.setDataHora(DATA_FIXA);

        assertAll("setters e getters",
                () -> assertEquals(3L,                        dto.getId()),
                () -> assertEquals("MULTA",                   dto.getTipo()),
                ...
                () -> assertEquals("Multa de cancelamento",   dto.getDescricao()),
    ...
    @Test
    @DisplayName("equals: dois DTOs vazios com mesma dataHora devem ser iguais")
    void equals_AmbosVazios_DeveSerIgual() {
        // Sem @Builder.Default em ExtratoResponseDTO, dataHora é null no NoArgsConstructor
