...
public class ContaService {
    ...
    public Conta criarEntidade(ContaRequestDTO dto) {
        ...
        // Unificando lógica: saldo inicial randômico e limite conforme a branch HEAD
        ...
        Conta conta = Conta.builder()
                ...
                .saldo(saldoInicial)
                .limiteCreditoDisponivel(limiteInicial)
    ...
    public Conta depositar(Long contaId, BigDecimal valor) {
        ...
        extratoService.registrar(conta, TipoExtrato.CREDITO, valor, saldoAntes, 
                saldoDepois, "Depósito em conta", null, null);
    ...
    public void debitarSaldo(Conta conta, BigDecimal valor, Pedido pedido, Pagamento pagamento, String descricao) {
        ...
        extratoService.registrar(conta, TipoExtrato.DEBITO, valor, saldoAntes, 
                saldoDepois, descricao, pedido, pagamento);
    }
    ...
    public void debitarLimiteCredito(Conta conta, BigDecimal valor, Pedido pedido, Pagamento pagamento, String descricao) {
        ...
        extratoService.registrar(conta, TipoExtrato.DEBITO, valor, antes, depois, descricao, pedido, pagamento);
    }
    ...
    return contaRepository.findByNumeroConta(NUMERO_CONTA_EMPRESA)
            .orElseThrow(() -> new RecursoNaoEncontradoException("Conta da empresa não encontrada"));
}
}